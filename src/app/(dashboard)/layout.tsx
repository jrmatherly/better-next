...
/**
 * Layout wrapper for the dashboard section that ensures only authenticated users can access these pages
 */
      ...
      <SidebarInset>
        <header className="sticky top-0 z-10 flex h-16 w-full shrink-0 items-center justify-between gap-2 border-b border-border bg-background/80 backdrop-blur-sm px-4">
          <div className="flex items-center gap-3">
            ...
            <SharedBreadcrumb section="dashboard" />
          </div>
          <div className="flex items-center gap-3">
            <ModeToggle />
          </div>
...
/**
 * Wrapper component to fetch session and pass it to DashboardSidebar
