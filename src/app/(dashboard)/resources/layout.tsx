...
import { ResourcesSidebarWrapper } from '@/components/layout/shared/resources-sidebar-wrapper';
...
function ResourcesLayout({
  ...
  return (
    <SidebarProvider>
      <ResourcesSidebarSessionFetcher />
      <SidebarInset>
 ...
 */
async function ResourcesSidebarSessionFetcher() {
  // Get the user's session
  const session = await getServerSession();
  return <ResourcesSidebarWrapper session={session as BetterAuthSession} />;
}

// Apply authentication protection to the layout
export default withAuthProtection(ResourcesLayout, {
  redirectTo: '/login',
